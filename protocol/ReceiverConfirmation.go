...
func (rcv *ReceiverConfirmation) Code() byte {
...
func (rcv *ReceiverConfirmation) MutateCode(n byte) bool {
...
func ReceiverConfirmationAddCode(builder *flatbuffers.Builder, code byte) {
